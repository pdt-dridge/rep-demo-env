...
/*
  Automation Actions - Easier to set up in the WebUI and reference here.
*/
...
/*
  Generic Users already created in the subdomain.
*/
data "pagerduty_user" "kate_miller" {
  email = "kate_miller@example.com"
}
data "pagerduty_user" "rob_smith" {
  email = "rob_smith@example.com"
}
data "pagerduty_user" "chelsea_west" {
  email = "chelsea_west@example.com"
}
data "pagerduty_user" "alex_baker" {
